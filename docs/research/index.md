...
| [アプリ本体の自動更新方式 調査メモ](app-update.md) | tufup / Velopack / 自前アップデータの比較と Phase B 方式決定の経緯（tufup を棄却し「Releases ＋ Sigstore attestation 検証」の自前方式を採用。実装は #252 / #253。**Phase B は #276 で撤去済み**・経緯も本メモに記録） |
