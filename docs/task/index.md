...
| タスク | ステータス | 概要 | 更新日 |
|---|---|---|---|
| [143-extension-enhancements.md](143-extension-enhancements.md) | 進行中 | ブラウザ拡張の改善（オプション i18n・manifest 英語化・バージョン同期・アイコン統一・リリース zip）と README 更新（Issue #143） | 2026-06-13 |
