...
| タスク | ステータス | 概要 | 更新日 |
|---|---|---|---|
| [276-remove-self-update](276-remove-self-update.md) | 進行中 | 自己更新（Phase B）を撤去し、更新通知＋リリースページ誘導（Phase A）のみへ戻す（[#276](https://github.com/f8924919/yt-gui/issues/276)） | 2026-07-18 |
