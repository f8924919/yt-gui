...
FORMAT_SPECS: dict[str, tuple[str, bool]] = {
    "fmt_best_mp4": ("bestvideo[ext=mp4]+bestaudio[ext=m4a]/bestvideo+bestaudio/best", False),
    "fmt_720p": ("bestvideo[height<=720][ext=mp4]+bestaudio[ext=m4a]/bestvideo[height<=720]+bestaudio/best", False),
