STRINGS: dict[str, str] = {
    ...
    "btn_check_update": "Check for yt-dlp Updates",
    "btn_check_app_update": "Check for yt-gui Updates",
    ...
    "check_app_update_on_startup": "Check for yt-gui updates at startup",
    "btn_browse": "Browse...",
    "btn_save": "Save",
    "btn_cancel": "Cancel",
    ...
    "section_mode_time": "Time range",
    "section_mode_chapter": "Chapter name",
    "section_chapter_pattern": "Regex:",
    "warn_section_chapter_invalid": "Please enter a valid regular expression for the chapter name (must not be empty).",
    "warn_section_chapter_no_match": "⚠️ No chapters matched the regex {pattern}; skipping the cut (keeping the full video).",
    "warn_section_chapter_nico_skip": "⚠️ Comment/danmaku post-processing is skipped when a chapter section is specified.",
    "tooltip_section_chapter": "Chapter",
